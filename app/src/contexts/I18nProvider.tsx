...
const en: Dict = {
  ...
  // Search
  'search.placeholder': 'Search… (Ctrl + /)',
...
const nb: Dict = {
  ...
  'dashboard.greeting': 'Godt å se deg igjen',
  'dashboard.kpi.applications': 'Søknader',
  'dashboard.kpi.interviews': 'Intervjuer',
  'dashboard.kpi.documents': 'Dokumenter',
  'dashboard.kpi.success': 'Suksessrate',
  'dashboard.charts.applications': 'Søknader over tid',
  'dashboard.charts.tasks': 'Oppgaver fullført vs ventende',
  'dashboard.reminders.upcoming': 'Kommende påminnelser',
  'dashboard.reminders.followup': 'Oppfølging trengs',
  ...
  'dashboard.reminder.add': 'Legg til påminnelse',
  'dashboard.reminder.title': 'Påminnelsestittel',
  'dashboard.reminder.when': 'Når',
  'dashboard.reminder.save': 'Lagre påminnelse',
  'dashboard.reminder.cancel': 'Avbryt',
  'dashboard.welcome.title': 'Velkommen, {name} 👋',
  'dashboard.welcome.interviewUpcoming': 'Du har et kommende intervju.',
  'dashboard.welcome.planWeek': 'Planlegg uken din.',
  'dashboard.welcome.weekendReminders': '3 påminnelser før helgen.',
  'dashboard.welcome.overview': 'Her er oversikten over jobbsøket ditt.',
  ...
  'dashboard.viewDetails': 'Se detaljer →',

  // Applications
  'applications.title': 'Jobbsøknader',
  'applications.add': 'Legg til søknad',
  'applications.edit': 'Rediger søknad',
  'applications.delete': 'Slett',
  'applications.status.applied': 'Søkt',
  'applications.status.interview': 'Intervju',
  'applications.status.offer': 'Tilbud',
  'applications.status.rejected': 'Avslått',
  'applications.status.appliedValue': 'Applied',
  'applications.status.interviewValue': 'Interview',
  'applications.status.offerValue': 'Offer',
  'applications.status.rejectedValue': 'Rejected',
  ...
  'applications.search': 'Søk i søknader...',
  ...
  'applications.companyRequired': 'Bedrift og stilling er påkrevd',
  'applications.createFailed': 'Kunne ikke opprette søknad',
  'applications.updateFailed': 'Kunne ikke oppdatere søknad',
  'applications.createApplication': 'Opprett søknad',
  'applications.table.company': 'Bedrift',
  'applications.table.position': 'Stilling',
  'applications.table.dateApplied': 'Søkt dato',
  'applications.table.status': 'Status',
  ...
  'applications.modal.title': 'Søknadsdetaljer',
  'applications.modal.editTitle': 'Rediger søknad',
  'applications.modal.createTitle': 'Opprett søknad',
  ...
  'tasks.dueSoon': 'Forfaller snart',
  'tasks.onTrack': 'På rett spor',
  'tasks.dueToday': 'Forfaller i dag',
  'tasks.all': 'Alle oppgaver',
  'tasks.type.note': 'Notat',
  'tasks.type.call': 'Telefon',
  'tasks.type.email': 'E-post',
  'tasks.type.meeting': 'Møte',
  'tasks.type.other': 'Annet',
  'tasks.taskTitle': 'Oppgavetittel',
  'tasks.description': 'Beskrivelse',
  'tasks.dueDate': 'Forfallsdato',
  'tasks.type': 'Type',
  'tasks.linkedApp': 'Knyttet søknad',
  'tasks.save': 'Lagre',
  'tasks.cancel': 'Avbryt',
  'tasks.markComplete': 'Merk som fullført',
  'tasks.markIncomplete': 'Merk som ufullført',
  'tasks.toDo': 'Å gjøre',
  'tasks.inProgress': 'Pågår',
  'tasks.done': 'Ferdig',
  'tasks.noMoreTasks': 'Ingen flere oppgaver funnet',
  'tasks.addNewTask': 'Legg til en ny oppgave for å holde deg organisert.',
  'tasks.createTask': 'Opprett oppgave',
  'tasks.editTask': 'Rediger oppgave',
  'tasks.deleteTask': 'Slett oppgave',
  'tasks.deleteConfirm': 'Er du sikker på at du vil slette denne oppgaven? Denne handlingen kan ikke angres.',
  'tasks.saveChanges': 'Lagre endringer',
  'tasks.titleRequired': 'Tittel er påkrevd',
  'tasks.linkRequired': 'Vennligst knytt denne oppgaven til en søknad',
  ...
  'documents.link': 'Knytt til søknad',
  'documents.unlink': 'Fjern kobling',
  'documents.name': 'Dokumentnavn',
  'documents.type': 'Filtype',
  'documents.size': 'Filstørrelse',
  'documents.uploaded': 'Lastet opp',
  'documents.linkedTo': 'Knyttet til',
  'documents.noDocuments': 'Ingen dokumenter lastet opp ennå',
  'documents.uploadNew': 'Last opp ditt første dokument',

  // Insights
  'insights.title': 'Innsikt',
  'insights.kpi.total': 'Totalt antall søknader',
  'insights.kpi.interviews': 'Intervjuer',
  'insights.kpi.offers': 'Tilbud',
  'insights.kpi.successRate': 'Suksessrate',
  'insights.charts.funnel': 'Søknadskonverterings-trengsel',
  'insights.charts.companies': 'Toppbedrifter søkt til',
  'insights.charts.outcomes': 'Jobbsøknadsresultater',
  'insights.charts.responseTime': 'Tid til første svar',
  'insights.charts.responseTimeByCompany': 'Tid til første svar (etter bedrift)',
  ...
  'insights.charts.keyMetrics': 'Nøkkeltall',
  'insights.weekly.title': 'Ukentlig fremgang',
  'insights.weekly.applications': 'Søknader',
  ...
  'insights.filters.last180': 'Siste 6 måneder',
  ...
  'profile.avatarInstructions': 'Klikk på avataren for å endre eller fjerne',
  ...
  'profile.reminderTime': 'Standard påminnelsestid',
  ...
  'profile.green': 'Grønn',
  'profile.fontSize': 'Skriftstørrelse',
  'profile.enable2FA': 'Aktiver tofaktorautentisering (2FA)',
  'profile.activeSessions': 'Aktive økter',
  'profile.session1': 'Mac • Chrome • Oslo · Aktiv nå',
  'profile.session2': 'iPhone • Safari • Sist aktiv for 2d siden',
  'profile.signOutSessions': 'Logg ut av alle andre økter',
  'profile.currentPlan': 'Nåværende plan: Gratis • 12 søknader sporet • 4 dokumenter lastet opp',
  ...
  'profile.sections.support': 'Støtte',
  ...
  // Search
  'search.placeholder': 'Søk… (Ctrl + /)',
  'search.suggestions.title': 'SØK I',
  'search.suggestions.applications': 'Søknader',
  ...
  'search.title': 'Søkeresultater for "{query}"',
  'search.tabs.all': 'Alle',
  'search.tabs.applications': 'Søknader',
  'search.tabs.tasks': 'Oppgaver',
  'search.tabs.documents': 'Dokumenter',
  'search.noResults.title': 'Ingen resultater funnet',
  'search.noResults.text': 'Prøv å justere søkeordene dine eller bla gjennom forskjellige kategorier.',
