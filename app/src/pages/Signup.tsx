...
export const Signup: FC = () => {
  ...
  return (
    <PageContainer>
      ...
      <ContentWrapper>
        <HeroSection>
          <HeroTitle>Create your free account</HeroTitle>
          <HeroDescription>Start organizing your applications today with reminders, documents, and a clear overview.</HeroDescription>
        </HeroSection>
        <FormContainer>
          <Card>
            <Title>Sign up</Title>
